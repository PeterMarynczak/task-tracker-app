 ...
 */
final class Version20220425095043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tasks_assigned_for_user ADD user_id INT NOT NULL, ADD id_of_user_who_created_the_task INT NOT NULL, DROP id_of_user_who_created_task_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tasks_assigned_for_user ADD id_of_user_who_created_task_id INT DEFAULT NULL, DROP user_id, DROP id_of_user_who_created_the_task');
